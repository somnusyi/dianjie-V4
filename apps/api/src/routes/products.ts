...
// preprocess: 把 null/空字符串统一转成 undefined, 让 .optional().default() 生效.
...
const productCreateSchema = z.object({
  ...
  stock:     productStockCreateSchema,
  minStock:  productMinStockCreateSchema,
  // 起订量 (默认 1)
  minOrderQty: productMinOrderQuantityCreateSchema,
  // 订量步长 (默认 1, 0/缺省视作 1)
  stepQty:   productStepQuantityCreateSchema,
...
const productPatchSchema = z.object({
  ...
  minOrderQty: productMinOrderQuantityPatchSchema,
  stepQty: productStepQuantityPatchSchema,
