...
describe('operation-group direct revision request contract', () => {
  ...
  it('accepts an empty desired list but rejects custom values beyond persisted precision', () => {
    expect(revisionCreateSchema.safeParse({ ...base, items: [] }).success).toBe(true)
