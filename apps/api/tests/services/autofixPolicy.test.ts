...
describe('core API gate (allowCoreBusinessApi option)', () => {
  ...
  it.each([
    ...
    'apps/api/src/routes/invoicePayments.ts',
    ...
    'apps/api/src/services/paymentMutex.ts',
    'apps/api/src/services/paymentSchedule.ts',
    'apps/api/src/services/cmbAutoSync.ts',
    'apps/api/src/services/invoicePaymentIntegrity.ts',
    'apps/api/src/services/cashbook.ts',
